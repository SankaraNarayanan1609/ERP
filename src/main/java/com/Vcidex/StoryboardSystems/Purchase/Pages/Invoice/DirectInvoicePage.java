...
public class DirectInvoicePage extends BasePage {
    ...
    /**
     * Constructor for DirectInvoicePage
     *
    ...
    public void saveAsDraft() {
        step(Layer.UI, "Save Invoice Draft", () ->
                click(saveDraftBtn, "Save As Draft"));
    }

    /** Cancels the form. */
    public void cancel() {
        step(Layer.UI, "Cancel Invoice", () ->
